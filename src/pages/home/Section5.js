      ...
      <section className="shop_section">
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="tex-xenter text-lg-start mb-5 mb-lg-0">
              <h4>Download mobile app and</h4>
              <h2>save up to 20%</h2>
              <p>
                Burgers are often enjoyed in relaxed settings, whether at a
                barbecue, diner, or food truck, making it easy for people to
                connect and engage in lighthearted conversations.
              </p>
              <Link to="/">
            ...
            <Col lg={6}>
              <img src={Download} alt="e-shop" className="img-fluid e_shop me-3" />
            </Col>
          </Row>
        </Container>
      </section>
